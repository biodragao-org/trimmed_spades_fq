# Nextflow wrapper for `spades` process.
...
```
nextflow run https://github.com/nextflow-hub/spades
```
...
```
nextflow run https://github.com/nextflow-hub/spades --filePattern './*_{1,2}.fastq.gz'
```
...
```
nextflow run https://github.com/nextflow-hub/spades --resultsDir /path/to/custom/resultsDir
```
...
```
nextflow run https://github.com/nextflow-hub/spades --saveMode move
```
